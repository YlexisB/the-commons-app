export const VOICERSS_API_URL = `https://voicerss-text-to-speech.p.rapidapi.com/`;

export const HEADER_STUFF = {
  siteName: "THE COMMONS",
  headerMotto: "a glimpse into an eye's present, and our past",
  about: "OUR STORY",
  aboutYou: "TELL YOUR STORY",
  contact: "CONTACT US",
  prompt: "CHOOSE A YEAR, READ SOMEONE'S STORY",
  year1: "1500",
  year2: "1600",
  year3: "1700",
  year4: "1800",
...
export const TELL_YOUR_STORY = {
  yourStoryPrompt:
    " Share your captivating story with us! Fill out a short excerpt about yourself or someone dear to you, and we'll send you an email with a form to provide more details. Join our storytellers community and let your narrative shine!",

  submission:
    " Thank you for submitting your story. We will send you an email regarding the next steps shortly.",
};

export const CONTACT_FORM = {
  prompt: "We'd love to hear from you!",
  submission: "Thank you for contacting us, we will get back to very soon!",
};
